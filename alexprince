...
\033[1;94m===============================================
\033[1;96m➣ Author : \033[1;96mAlex Prince
\033[1;96m➣ Alex GANG  : \033[1;96mHITTLER HACKING MAFIA
\033[1;96m➣ WP  : \033[1;96m03171168085
\033[1;94m==============================================="""
...
def reg():
    ...
    r = requests.get('https://github.com/try-py/alexprince/edit/main/server.txt').text
    if to in r:
...
def menu_s():
    ms = raw_input('\x1b[1;97m\xe2\x95\xb0\xe2\x94\x80ALEX\xe2\x9e\xa4 ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        choice_crack()
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80ALEX\xe2\x9e\xa4 ')
    if a_s == '1':
        os.system('clear')
        print logo
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mALEX PRINCE Kings Of Facebook\x1b[1;91m'
    print 47 * '-'
...
def c_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mALEX PRINCE Kings Of Fcebook\x1b[1;91m'
    print 47 * '-'
